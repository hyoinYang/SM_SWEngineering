...
class ManagementModel:
    ...
    # 삭제하기
    def delete_enter(event, del_entry):
        # 입력 상자에서 입력된 내용 가져오기
        word = del_entry.get()
    ...
    # 수정하기
    def modify_enter(event, modify_word_entry, modify_korean_entry, modify_ex_entry):
        # 입력 상자에서 입력된 내용 가져오기
    ...
    # 추가하기
    def add_enter(event, add_word_entry, add_korean_entry, add_ex_entry):
        # 입력 상자에서 입력된 내용 가져오기
