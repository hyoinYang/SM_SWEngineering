...
def gear_btn_click():
    if is_admin:
        ...
        messagebox.showinfo("정보", "사용자 입니다.")
...
def btn3_page(): # "오답노트" 버튼
    pass

def btn4_page(): # "토익 시험 날짜" 버튼
    import exam_schedule_seyeon as schedule

    btn4_fm = tk.Frame(main_fm)
    btn4_fm.pack(fill=tk.BOTH, expand=True)
    controller = schedule.TOEICScheduleController(btn4_fm)


def btn5_page(): # "고사장 안내 및 시험 점수 조회" 버튼
