...
class LoginView:
    ...
    def setup_ui(self):
        title = tv.TitleView(self.root, "로그인")
        title.init_title()
        ...
        login_button = tk.Button(title.canvas, image=login_icon, relief="flat", bd=0, command=lambda:LoginModel.validate_login(self, "testid", "testpass"), cursor="hand2")
        ...
        signup_button = tk.Button(title.canvas, image=signup_icon, relief="flat", bd=0, command=lambda:LoginModel.validate_signup(self), cursor="hand2")
