...
from wordDB.wordRead import read_all_words
from wordDB.wordSound import wordSound
...
def create_scrollable_text(parent_frame, text): # text에는 박스에 있는 영어 단어가 옴
    ...
    sound_button = tk.Button(white_box,image = sound_button_image, relief="flat",command=lambda:wordSound(text),bd=0) # 나중에 음성 모듈로 바꿔주기
