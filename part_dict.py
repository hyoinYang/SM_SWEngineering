...
class PartDictModel:
    def __init__(self,part_index,dictionary_db,cnt):
        ...
        self.word = dictionary_db.dictionary[part_index*10:part_index*10+cnt] # 이 파트에 들어가는 단어 , 나중에 10을 120으로 수정
        self.sentence = dictionary_db.sentence[part_index*10:part_index*10+cnt] # 이 파트에 들어가는 예문, 나중에 10을 120으로 수정
